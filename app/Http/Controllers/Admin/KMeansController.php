...
class KMeansController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Data Deskripsi untuk View
        $stats = [
            'criteria_count' => \App\Models\Criterion::count(),
            'teacher_count' => \App\Models\User::where('role', 'teacher')->where('is_active', true)->count(),
    ...
    public function calculate(Request $request)
    {
        ...
        if (!$syncResult['status']) {
            return redirect()->route('admin.kmeans.index')
