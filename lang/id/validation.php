...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut memuat pesan kesalahan default yang digunakan oleh
    | kelas validator. Beberapa aturan memiliki banyak versi seperti
    | aturan ukuran. Silakan ubah setiap pesan di sini sesuai keinginan.
    |
    */
