...
Route::get('/setup-database', function() {
    try {
        // 1. Jalankan Migrasi (Fresh akan menghapus semua tabel lama)
        // Gunakan --force karena ini di lingkungan Production/Hosting
        ...
        // 3. Clear Cache agar sinkron
        Artisan::call('config:clear');
        Artisan::call('cache:clear');

        return "<h1>Database Setup Berhasil!</h1>
                <p><b>Migration:</b> " . nl2br($output1) . "</p>
                <p><b>Seeding:</b> " . nl2br($output2) . "</p>";
                
    } catch (\Exception $e) {
        return "Gagal menjalankan setup: " . $e->getMessage();
    }
});
